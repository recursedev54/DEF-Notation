...
# Create main window
root = tk.Tk()
root.title("MIDI to DEF Converter (Hi-Hat Pattern)")
...
# Convert button
convert_button = tk.Button(root, text="Convert to DEF", command=convert_hihat_to_def)
